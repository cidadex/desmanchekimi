      ...
      <section className="py-24 bg-card relative overflow-hidden border-t">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Escolha o plano que melhor se adapta ao seu desmanche: mensalidade fixa ou porcentagem sobre vendas. O credenciamento é rigoroso, mas o resultado é garantido.
          </p>
          <RegisterModal defaultTab="desmanche">
